...
data class Note(
    ...
    @ColumnInfo(name = "image_uri") val imageUri: String? = null, // URI of the original image, if applicable
    @ColumnInfo(name = "tags") val tags: List<String> = emptyList(), // AI-generated or user-defined tags
