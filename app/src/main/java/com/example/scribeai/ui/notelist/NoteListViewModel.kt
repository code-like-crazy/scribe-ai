...
class NoteListViewModel(private val repository: NoteRepository) : ViewModel() {
    ...
    val notes: StateFlow<List<Note>> = _searchQuery
        ...
        .stateIn(
            ...
            started = SharingStarted.WhileSubscribed(5000), // Keep flow active for 5s after last observer
...
/**
 * Factory class to instantiate NoteListViewModel with its dependencies (NoteRepository).
